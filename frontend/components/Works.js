...
export default function Project() {
  ...
  return (
    <section className="works bg-cover  py-20 px-6 sm:px-12 bg-black/50 rounded-t-full">
      <h2
        className={`{${baloo.className} text-center text-2xl sm:text-3xl font-extrabold mb-12 tracking-widest uppercase text-gray-700 shadow-lg shadow-gray-500 bg-[#c7c7c7] p-3 w-100 rounded-full`}
